...
(let* ((get-color (lambda (graphic-color terminal-color)
  ...
  (custom-theme-set-faces
   ...
   ;; whitespace-mode
   `(whitespace-space            ((t (:foreground ,faded_gray))))
   `(whitespace-hspace           ((t (:foreground ,faded_gray))))
   `(whitespace-tab              ((t (:foreground ,faded_gray))))
   `(whitespace-newline          ((t (:foreground ,faded_gray))))
   `(whitespace-trailing         ((t (:foreground ,bright_red))))
   `(whitespace-line             ((t (:foreground ,bright_red))))
   `(whitespace-space-before-tab ((t (:foreground ,bright_gray))))
   `(whitespace-indentation      ((t (:foreground ,dark2))))
   `(whitespace-empty            ((t (:foreground ,bright_red))))
   `(whitespace-space-after-tab  ((t (:foreground ,faded_gray))))
   ...
   `(custom-group-tag               ((t (:foreground ,bright_aqua :weight bold :height 1.2 :inherit variable-pitch))))
   `(custom-group-tag-1             ((t (:foreground ,neutral_purple :inherit custom-group-tag))))
